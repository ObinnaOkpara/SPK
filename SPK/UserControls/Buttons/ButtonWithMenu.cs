...
{
    public partial class ButtonWithMenu : UserControl
    {
        ...
        private void ButtonWithMenu_Resize(object sender, EventArgs e)
        {
            imgLeft.Top = (Height - imgLeft.Height) / 2;
            imgRight.Top = (Height - imgRight.Height) / 2;
        }
        
        private void ButtonWithMenu_Load(object sender, EventArgs e)
        {
